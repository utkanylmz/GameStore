...
namespace Core.Persistence.Paging
{
    public static class IQueryablePaginateExtensions
    {
        ...
        //IQueryable'ı extend edip belirtilen sayfa boyutu (size) ve belirtilen sayfa indeksi
        //(index) kullanılarak veri kaynağından belirtilen sayfayı alır.Geriye Paginate
        //yapımı döndürür.
