...
namespace Core.Persistence.Paging
{
    ...
    {
        //Sayfalama işlemi sonucunda elde edilen verileri tutmak için kullanılır.
        //sayfa indeksi, boyutu, kaynak toplam sayısı,
        //toplam sayfa sayısı ve bir önceki/sonraki sayfa olup olmadığını belirtir
    ...
    {//Paginate<TSource, TResult> sınıfı, bir veri kaynağından öğeleri TResult öğelerine dönüştürür ve sayfalama
     //bilgilerini sağlar. Bu sınıf, ayrıca dönüştürülmüş öğelerin bir koleksiyonunu da tutar ve sayfalama işlemi
